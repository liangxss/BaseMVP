...
import com.example.spannablelib.R;

public class MainActivity extends Activity implements OnClickableSpanListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SimplifySpanBuild simplifySpanBuild1 = new SimplifySpanBuild(this, tvText1);
        simplifySpanBuild1.appendNormalText("正常").appendSpecialUnit(new SpecialImageUnit(BitmapFactory.decodeResource(getResources(), R.drawable.ic_bulletin), 50, 50).setGravity(SpecialGravityEnum.CENTER)).appendNormalText("正常正常正常正常正常正常正常正常正常正常正常正常正常正常正常正常正常正常正常正常正常正常正常");
...
//        tvText1.setText(simplifySpanBuild1.build());
        ...
        simplifySpanBuild3.appendSpecialUnit(new SpecialImageUnit(BitmapFactory.decodeResource(getResources(), R.drawable.ic_bulletin), 50, 50).setGravity(SpecialGravityEnum.CENTER))
                          ...
                          .appendNormalText("正常")
                          .appendSpecialUnit(new SpecialImageUnit(BitmapFactory.decodeResource(getResources(), R.drawable.ic_launcher), 50, 50).setGravity(SpecialGravityEnum.CENTER))
                          .appendNormalText("正常")
                          .appendSpecialUnit(new SpecialImageUnit(BitmapFactory.decodeResource(getResources(), R.drawable.ic_launcher), 50, 50).setGravity(SpecialGravityEnum.TOP))
                          .appendNormalText("正常")
                          .appendSpecialUnit(new SpecialImageUnit(BitmapFactory.decodeResource(getResources(), R.drawable.ic_launcher), 50, 50).setGravity(SpecialGravityEnum.BOTTOM));
